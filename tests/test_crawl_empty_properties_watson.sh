...
# The CRAWLER_METRIC_PREFIX property in /etc/csf_env.properties 
# file # is uninitialized. Should result in skipping the container
...
python2.7 ../config_and_metrics_crawler/crawler.py --crawlmode OUTCONTAINER \
	...
	--environment watson --namespace ${HOST_NAMESPACE} --numprocesses 1 > /tmp/check_metadata_frame
