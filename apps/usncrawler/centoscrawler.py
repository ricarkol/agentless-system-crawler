...
def process_centos_advisory(advisory_data):
    ...
    #print (json.dumps(centos_advisory_update, indent=2))
    return centos_advisory_update
                

def crawl_centos_advisories(logger, centos_url, repo_dir):
    
    logger.info('Centos Crawler starts')
...
if __name__ == '__main__':
    ...
    centos_url='https://lists.centos.org/pipermail/centos-announce/'
    repo_dir='./usnrepo'
    crawl_centos_advisories(centos_url, repo_dir)
