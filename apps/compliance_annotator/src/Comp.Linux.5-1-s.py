...
if __name__ == '__main__':
    ...
    target_file_list = ["/etc/snmpd.conf", "/etc/snmp/snmpd.conf", "/etc/snmpd/snmpd.conf"]
    ...
    outstr = CheckCompliance(prefix, "Linux.5-1-s", input_namespace, input_tm, input_reqid, ret_status)
