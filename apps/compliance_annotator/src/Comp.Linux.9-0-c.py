...
if __name__ == '__main__':
    ...
    # Leaving these codes here uncommented so that I can add new packges to check later.
    # Note that the str_reason is appended to the first one to collect all the package names that conflict with this rule
    ...
    #            version_info = " of version "+pkgline.strip().split()[1]
    #        str_compliant = "false"
    #        str_reason = str_reason + "rsh server package, "+pkgname+version_info+", found. " # str_reason is appended to the previous one
    #        break;
