...
/usr/bin/python  /home/cloudadmin/scanner-commandline-tool/scanner-reading-from-elasticsearch.py --elasticsearch-wrapper-server-url $SEARCH_URL --kafka_url $KAFKA_URL  --begin_time `date --date "2015-02-10" "+%s"`  --end_time  `date --date "2015-04-04" "+%s"`
