...
if __name__ == '__main__':
    ...
    target_file_list = ["/var/log/faillog", "/lib/security/pam_tally2.so", "/lib64/security/pam_tally2.so" ]
    ...
    outstr = CheckCompliance(prefix, "Linux.5-1-m", input_namespace, input_tm, input_reqid, ret_status)
