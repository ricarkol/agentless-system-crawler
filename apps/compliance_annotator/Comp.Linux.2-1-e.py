...
if __name__ == '__main__':
    ...
    target_file_list = ["/etc/pam.d/system-auth", "/etc/pam.d/login","/etc/pam.d/passwd"]
    ...
    outstr = CheckCompliance(prefix, "Linux.2-1-e", input_namespace, input_tm, input_reqid, ret_status)
