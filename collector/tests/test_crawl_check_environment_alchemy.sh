...
# Tests the alchemy environment.  2 containers are created, one ready for
# alchemy, and one not. Check that only the alchemy one is crawled.  Returns 1
...
# Only contianer 1 with alchemy metadta should be crawled: N1=1 and N2=1
# Container 1 should be crawled, and its namespace should be in alchemy format: N3=0 and N4=1
# Container 2 should not be crawled: N5=0
if [ $N1 == "1" ] && [ $N2 == "1" ] && [ $N3 == "0" ] && [ $N4 == "1" ] && [ $N5 == "0" ]
then
	echo 1
else
	echo 0
